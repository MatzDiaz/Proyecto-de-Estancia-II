...
<body>
    <? include "principal_alum.php";?>
    <!--Aqui comienza el perfil de usuario-->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.min.js"></script>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <div class="container w-50" >
        <form action=   "../CONTROLADOR/controlador_operacionesAlu.php" method="POST" class="was-validated">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Regresar</button>
                    <button type="submit" class="btn btn-primary bg-danger pt" name="btnEliminar">Eliminar cuenta</button>
                </div>
                </div>
            </div>
            </div>
