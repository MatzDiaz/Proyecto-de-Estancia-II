...
<div class="col-9 p-4">
    <table class="table">
        ...
        <!-- Modal guardar -->
        <form action="../CONTROLADOR/controlador_ModiAlumnos.php" method="POST"  class="was-validated">
            <div class="modal fade" id="mdGuardar<?=$datos->idAlum?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="mb-3 mt-3">
                            ...
                            <div class="valid-feedback" id="namefeedback"></div>
                            <div class="invalid-feedback" id="namefeedback">El nombre no puede estar vacio</div>
                        </div>
                        <div class="mb-3 mt-3">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">El correo no puede estar vacio</div>
                        </div>
        ...
        <!-- Modal  registrar-->
        <form action="../CONTROLADOR/controlador_RegAlumnos.php" method="POST"  class="was-validated">
            <div class="modal fade" id="mdRegistro" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <div class="mb-3 mt-3">
                            <label for="correo" class="form-label">Correo:</label>
                            <input type="text" class="form-control" id="correo" name="correo" placeholder="usuario@dominio" required >
                            <div class="valid-feedback"></div>
                            <div class="invalid-feedback">El correo no puede estar vacio</div>
                        </div>
                        <div class="mb-3">
