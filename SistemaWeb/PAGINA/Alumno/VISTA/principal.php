...
<!--Menu-->
        ...
        <a class="navbar-brand" href="perfil.php"><img src="../../../IMG/usuario.png" width=40 >Administrador <br><label value="<?php echo $_SESSION?>"></label></a>
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-1">
                ...
                <li class="nav-item">
                <a class="navbar-brand" aria-current="page" href="#"><img src="../../../IMG/lista.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
                ...
                <li class="nav-item">
                <a class="navbar-brand" aria-current="page" href="#"><img src="../../../IMG/copia.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
